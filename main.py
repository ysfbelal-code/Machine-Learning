...
with open("hand_landmarker.task", "rb") as task_file:
    st.download_button("Download hand_landmarker.task from Google AI for Developers (NECESSARY FOR MEDIAPIPE TASKS)", data=task_file, file_name="hand_landmarker.task")
